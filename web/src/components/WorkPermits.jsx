          ...
          <div className="min-w-[900px] sm:min-w-full px-4 sm:px-0">
            ...
            <thead className="bg-gradient-to-r from-blue-50 to-indigo-50 sticky top-0 z-10">
              <tr>
                ...
                <th className="px-3 py-4 text-left text-xs font-bold text-indigo-700 uppercase tracking-wider sticky top-0 w-32">📄 Permit</th>
                <th className="px-3 py-4 text-left text-xs font-bold text-indigo-700 uppercase tracking-wider sticky top-0 w-28">💼 Job</th>
                <th className="px-3 py-4 text-left text-xs font-bold text-indigo-700 uppercase tracking-wider sticky top-0 w-32">🏢 Employer</th>
                <th className="px-3 py-4 text-left text-xs font-bold text-indigo-700 uppercase tracking-wider sticky top-0 w-28">⏰ Expiry</th>
                <th className="px-3 py-4 text-left text-xs font-bold text-indigo-700 uppercase tracking-wider sticky top-0 w-28">📊 Status</th>
                <th className="px-3 py-4 text-right text-xs font-bold text-indigo-700 uppercase tracking-wider sticky top-0 w-24">⚙️</th>
              </tr>
            </thead>
              ...
              {filteredPermits.map((permit) => {
                ...
                return (
                  <tr key={permit.id} className="hover:bg-blue-50/50 transition-colors">
                    <td className="px-3 py-4 whitespace-nowrap text-sm font-bold text-gray-900 truncate max-w-[140px]" title={getEmployeeName(permit.employeeId)}>
                      {getEmployeeName(permit.employeeId)}
                    </td>
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-700 font-medium">
                      {permit.permitNumber}
                    </td>
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-700 truncate max-w-[120px]" title={permit.jobPosition}>
                      {permit.jobPosition}
                    </td>
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500 truncate max-w-[120px]" title={permit.employer}>
                      {permit.employer}
                    </td>
